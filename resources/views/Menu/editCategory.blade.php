                ...
                <div class="widget-body">
                    <div class="widget-main">
                        <div id="fuelux-wizard-container">
                            <h3 class="text-center">Update Menu Category</h3>
                                ...
                                <div class="col-md-10 col-lg-10 col-sm-12 col-xs-12 col-md-offset-1 col-lg-offset-1">
                                    ...
                                    <div class="step-content pos-rel">
                                        <div class="step-pane active" data-step="1">
                                            ...
                                            <form action="{{ route('addCategory.update',$view->id)}}" method="post"
                                ...
                                <span class="block input-icon input-icon-right">
                                    ...
                                    <i class="ace-icon fa fa-leaf"></i>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-xs-12 col-sm-12 col-md-12 padding">
                                <span class="block input-icon input-icon-right">
                                    <input type="text" name="url" value="{{$view->url}}" id="link"
                                           class="width-100"/>
                                                        ...
                                                        <div class="col-xs-12 col-sm-12 col-md-12 padding">
                                                                <span class="block input-icon input-icon-right">
                                                                    <input type="text" name="position" placeholder="Position" id="icon"
                                                                           value="{{$view->position}}"     class="width-100"/>
                                                                    <i class="ace-icon fa fa-leaf"></i>
                                                                </span>
                                                        </div>
                                                    </div>
