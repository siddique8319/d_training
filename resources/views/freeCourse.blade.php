            ...
            <div class="row">
                ...
                <div class="col-sm-10 col-md-offset-1 padding">
                    ...
                    <div class="col-md-12 padding modal_header">
                        <div class="col-md-11">
                            <div class="media-body quick_view_name">
                                <h2 class="text-center"> Free Seminar of DoofazIT </h2>
                            </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <form role="form" action="{{route('FreeSeminner.store')}}" method="post"
                            ...
                            <div class="row setup-content" id="step-2">
                                <div class="col-xs-12">
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-12 full_form_box">
                                            <h4>Which Type Course you Want to Attend </h4>
                                            ...
                                            <div class="col-md-12 modal_form_box">
                                                ...
                                                <div class="col-md-6 padding">
                                                    ...
                                                    <div class="col-xs-12">
                                                        ...
                                                        <label class="radio">
                                                            <input type="radio" name=" Ethical Hacking"
                                                                   id="inlineRadio3" value="option3"> Ethical Hacking
                                                        </label>
                                                    </div>
                                                </div>
                    ...
                    <div class="col-md-12">
                        <div class="col-md-12 full_form_box">
                            ...
                            <div class="col-md-12 modal_form_box">
                                ...
                                <div class="col-xs-12">
                                    <div class="form-group">
                                        <label for="inputPassword3" class="col-sm-4 control-label">Where From
                                            Know About Doofaz IT : </label>
                                        <div class="col-sm-8">
                                            ...
                                            <label class="checkbox-inline">
                                                <input type="checkbox" name="how_know_doofazit"
                                                       id="inlineRadio3" value="Student of DoofazIT"> Student of
                                                DoofazIT
                                            </label>
                                            <label class="checkbox-inline">
                                                <input type="checkbox" name="how_know_doofazit"
                                ...
                                <div class="col-xs-12 class">
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            <label class="checkbox-inline">
                                                <input type="checkbox" required="" name="inlineRadioOptions"
                                                       id="inlineRadio2" value="option2"> Hereby apply for
                                                admission to the above program in this institute I Agree to
                                                abide by all the rules and regulation of the institute
                                            </label>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-md-12">
                            <input class="btn btn-primary  btn-sm pull-right next_btn" type="submit"
                                   name="free_seminer_submit" value="Finish">
                        </div>
                    </div>
                </div>
            </div>
