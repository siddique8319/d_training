...
<div id="fuelux-wizard-container">
    <h3 class="text-center">Blog Information </h3>
        ...
        <div class="step-pane active" data-step="1">
             ...
             @if (count($errors) > 0)
               ...
               @endif
                ...
                <form action="{{route('AdminBlog.store')}}" method="post" enctype="multipart/form-data" class="form-horizontal" id="sample-form">
...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                 ...
                 <table class="table table-bordered table-responsive">
                     <tr>
                         <th>Sl</th>  <th>Title</th> <th>Description</th> <th>Photo</th> <th>Delete</th>
                     </tr>
                     ...
                     <tr>
                        ...
                        <td><img src="{{url('photo/'.$value->image)}}" style="height: 100px; width:200px;"></td>
                            ...
                            <td>
                                 <div class="action-buttons">
                                     ...
                                     <a class="red" href="{{Route('AdminBlog.show',$value->id)}}">
