...
<div id="fuelux-wizard-container">
    <h3 class="text-center">Our Program Information </h3>
        ...
        <div class="step-pane active" data-step="1">
             ...
             @if (count($errors) > 0)
               ...
               @endif
                ...
                <form action="{{route('OurProgramAdmin.store')}}" method="post" enctype="multipart/form-data" class="form-horizontal" id="sample-form">
...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="col-lg-10 col-md-8 col-sm-10 col-xs-12 col-lg-offset-1 col-md-offset-1 col-sx-offset-1">
                 <table class="table table-bordered table-responsive">
                     <tr>
                         <th>Sl</th>  <th>Title</th> <th>Url link</th> <th>Delete</th>
                     </tr>
                        ...
                        <td>{{$value->url_link}}</td>
                            ...
                            <td>
                                 <div class="action-buttons">
                                     <a class="green" href="{{Route('OurProgramAdmin.edit',$value->id)}}">
                                            <span class="glyphicon glyphicon-edit fa-2x"></span>
                                     </a>

                                     <a class="red" href="{{Route('OurProgramAdmin.show',$value->id)}}">
