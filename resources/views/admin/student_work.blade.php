        ...
        <div class="step-pane active" data-step="1">
             ...
             @if (count($errors) > 0)
               ...
               @endif
                ...
                <form action="{{route('StudentAdminProject.store')}}" method="post" enctype="multipart/form-data" class="form-horizontal" id="sample-form">
                        ...
                        <td><img src="{{url('photo/'.$value->image)}}" style="height: 100px;"></td>
                            ...
                            <td>
                                 <div class="action-buttons">
                                     <a class="green" href="{{Route('StudentAdminProject.edit',$value->id)}}">
                                            <span class="glyphicon glyphicon-edit fa-2x"></span>
                                     </a>

                                     <a class="red" href="{{Route('StudentAdminProject.show',$value->id)}}">
