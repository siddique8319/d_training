...
@section('admin-container')
    <div class="main-content">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="head-title"><h3>Diploma Course Application information</h3></div>
                            ...
                            @if ($value->status == 0)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form action="{{ route('DiplomaCourse.edit',$value->id) }}">
                                            <button class="btn btn-success"><i
                                                        class="glyphicon glyphicon-check"></i>
                                            </button>
                                        </form>

                                        <form action="{{ route('DiplomaCourse.destroy',$value->id) }}"
                                              method="post">
                                            {{ csrf_field()}}
                                            {{ method_field('DELETE')}}
