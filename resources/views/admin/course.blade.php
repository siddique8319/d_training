                        ...
                        <div id="fuelux-wizard-container">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="col-md-10 col-lg-10 col-sm-12 col-xs-12 col-md-offset-1 col-lg-offset-1">
                                    ...
                                    <div class="step-content pos-rel">
                                        <div class="step-pane active" data-step="1">
                                            ...
                                            <form action="{{route('CourseAdmin.store')}}" method="post"
                                ...
                                <span class="block input-icon input-icon-right">
                                    <input type="text" name="course_name" placeholder="Course name" id="title"
                                           class="width-100"/>
                                    <i class="ace-icon fa fa-leaf"></i>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-xs-12 col-sm-12 col-md-12 padding">
                                <span class="block input-icon input-icon-right">
                                    <input type="text" name="course_title" placeholder="Course title" id="title1"
                                           class="width-100"/>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-xs-12 col-sm-12 col-md-12 padding">
                                <span class="block input-icon input-icon-right">
                                    <input type="text" name="price" placeholder="Course Fee" id="price"
                                           class="width-100"/>
                                    <i class="ace-icon fa fa-leaf"></i>
                                </span>
                                                        </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-xs-12 col-sm-12 col-md-12 padding">
                                <span class="block input-icon input-icon-right">
                                    <input type="text" name="total_class" placeholder="Total class" id="d"
                                           class="width-100"/>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-xs-12 col-sm-12 col-md-12 padding">
                                <span class="block input-icon input-icon-right">
                                    <input type="text" name="class_duration" placeholder="Class duration" id="dur"
                                           class="width-100"/>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-xs-12 col-sm-12 col-md-12 padding">
                                <span class="block input-icon input-icon-right">
                                    <textarea class="form-control" name="course_description" id="des"
                                              placeholder="Course Discription"></textarea>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-xs-12 col-sm-12 col-md-12 padding">
                                <span class="block input-icon input-icon-right">
                                    <textarea class="form-control" name="career_support" id="des"
                                              placeholder="Career Support Discription"></textarea>
