...
<div id="fuelux-wizard-container">
    <h3 class="text-center">Software Module Information </h3>
        ...
        <div class="step-pane active" data-step="1">
             ...
             @if (count($errors) > 0)
               ...
               @endif
                ...
                <form action="{{route('SoftwareModule.store')}}" method="post" enctype="multipart/form-data" class="form-horizontal" id="sample-form">
                        ...
                        <td>{{$value->title}}</td>
                            ...
                            <td>
                                 <div class="action-buttons">
                                     <a class="green" href="{{Route('SoftwareModule.edit',$value->id)}}">
                                            <span class="glyphicon glyphicon-edit fa-2x"></span>
                                     </a>

                                     <a class="red" href="{{Route('SoftwareModule.show',$value->id)}}">
