													...
													<tr>
														...
														<td>
															<div class="hidden-sm hidden-xs action-buttons">
																...
																<a class="green" href="delete.php?Approve_student=<?php echo $fetch['reg_id'] ?>">
																	<span class="glyphicon glyphicon-check fa-2x"></span>
																</a>

																<a class="red" href="delete.php?Cancel_student_delete=<?php echo $fetch['reg_id'] ?>">
