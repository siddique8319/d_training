...
<div id="fuelux-wizard-container">
    <h3 class="text-center"> Cetification Program Information </h3>
        ...
        <div class="step-pane active" data-step="1">
             ...
             @if (count($errors) > 0)
               ...
               @endif
                ...
                <form action="{{route('CertificationAdmin.store')}}" method="post" enctype="multipart/form-data" class="form-horizontal" id="sample-form">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 padding">
                 ...
                 <table class="table table-bordered table-responsive">
                     ...
                     <tr>
                        <td>{{$value->id}}</td>
                        <td>{{$value->title}}</td>
                        <td><img src="{{url('photo/'.$value->image)}}" class="img img-responsive" style=" height: 120px;"></td>
                  
                   
                            <td>
                                 <div class="action-buttons">
                                     <a class="green" href="{{Route('CertificationAdmin.edit',$value->id)}}">
                                            <span class="glyphicon glyphicon-edit fa-2x"></span>
                                     </a>

                                     <a class="red" href="{{Route('CertificationAdmin.show',$value->id)}}">
