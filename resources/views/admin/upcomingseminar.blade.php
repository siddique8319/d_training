                ...
                <div class="widget-body">
                    <div class="widget-main">
                        <div id="fuelux-wizard-container">
                            <h3 class="text-center">Upcoming Seminar Information </h3>
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <div class="step-content pos-rel">
                                        <div class="step-pane active" data-step="1">
                                            ...
                                            <form action="{{route('UpcomingSeminar.store')}}" method="post"
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="action-buttons">
                                            <a class="green" href="{{Route('UpcomingSeminar.edit',$value->id)}}">
                                                <span class="glyphicon glyphicon-edit fa-2x"></span>
                                            </a>

                                            <a class="red" href="{{Route('UpcomingSeminar.show',$value->id)}}">
