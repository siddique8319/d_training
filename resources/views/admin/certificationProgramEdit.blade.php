...
<div id="fuelux-wizard-container">
    <h3 class="text-center"> Certification Program  Update </h3>
    ...
    <div class="step-content pos-rel">
        <div class="step-pane active" data-step="1">
                ...
                <form action="{{route('CertificationAdmin.update',$view->id)}}" method="post" enctype="multipart/form-data" class="form-horizontal" id="sample-form">
