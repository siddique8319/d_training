            ...
            <div class="row">
                ...
                <div class="col-sm-10 col-md-offset-1 padding">
                    ...
                    <div class="col-md-12 padding">
                        ...
                        <form role="form" action="{{route('DiplomaCourse.store')}}" method="post"
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-12 full_form_box">
                                            ...
                                            <div class="col-md-12 modal_form_box">
                                                ...
                                                <div class="col-md-6 col-md-offset-3 padding">
                                                    ...
                                                    <div class="col-xs-12">
                                                        <div class="form-group">
                                                            <input maxlength="100" name="session_year" type="text"
                                                                   required="required" class="form-control"
                                                                   placeholder="session"/>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="col-md-12 full_form_box">
                                            ...
                                            <div class="col-md-12 modal_form_box">
                                                ...
                                                <div class="col-md-6 col-md-offset-3">
                                                    <label class="radio">
                                                        <input type="radio" name="session_time" id="inlineRadio2"
                                                               value="3 Month"> 3 Month
                                                    </label>
                                                    <label class="radio">
                                                        <input type="radio" name="session_time" id="inlineRadio3"
                                                               value="6 Month"> 6 Month
                                                    </label>
                                                </div>
                                                        ...
                                                        <div class="col-sm-10">
                                                            <label class="radio-inline">
                                                                <input type="radio" name="course_day" id="inlineRadio2"
                                                                       value="option2"> ( Saturday / Tuesday / Thursday
                                                                )
                                                            </label>
                                                            <label class="radio-inline">
                                                                <input type="radio" name="course_day" id="inlineRadio3"
                                                                       value="option3"> ( Sunday / Monday / Wednesday )
                                                            </label>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-12">
                                            <input class="btn btn-primary  btn-sm pull-right next_btn" type="submit"
                                                   name="diploma_Course_submit" value="Finish">
                                        </div>
                                    </div>
                                </div>
                            </div>
